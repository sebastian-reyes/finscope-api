 ...
 *
 * Los nombres de las propiedades evitan a propósito llamarse `id`, `name`, `color` o `icon`,
 * por el mismo motivo que {@link TransactionTagName}: coincidirían con las propiedades
 * homónimas de
 ...
 * @param tagColor         color elegido para su ficha, nulo si se deduce del nombre
 * @param tagIcon          icono elegido para su ficha, nulo si se deduce del nombre
 * @param transactionCount cuántas transacciones del usuario llevan el tag, cero si ninguna
 */
public record TagUsage(Long tagId, String tagName, String tagColor, String tagIcon,
